defmodule LiveIslands.Patch do
  @moduledoc """
  Encodes LiveIslands patch operations into the compact wire format used by
  `data-props-diff` and `data-streams-diff`.

  The payload is a concatenated sequence of operations. Dynamic text fields are
  byte-length-prefixed, so paths and values can contain delimiters without
  additional escaping.
  """
