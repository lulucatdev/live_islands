defmodule LiveIslandsExamplesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(LiveIslandsExamplesWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(LiveIslandsExamplesWeb.Gettext, "errors", msg, opts)
    # end
