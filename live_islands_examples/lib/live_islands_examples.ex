defmodule LiveIslandsExamples do
  @moduledoc """
  LiveIslandsExamples keeps the contexts that define your domain
  and business logic.
  ...
  @url "https://github.com/lulucatdev/live_islands/blob/main/live_islands_examples"
  @raw_url "https://raw.githubusercontent.com/lulucatdev/live_islands/main/live_islands_examples"
  @dead_views "/lib/live_islands_examples_web/controllers/page_html"
  @live_views "/lib/live_islands_examples_web/live"
  ...
  def demo(:server_only) do
    %{
      view_type: "DeadView",
      raw_view_url: "#{@raw_url}#{@dead_views}/server_only.html.heex",
      view_url: "#{@url}#{@dead_views}/server_only.html.heex",
      raw_react_url: "#{@raw_url}#{@react}/benchmark-static-report.jsx",
      react_url: "#{@url}#{@react}/benchmark-static-report.jsx"
    }
  end
  ...
  def demo(:capabilities) do
    %{
      raw_view_url: "#{@raw_url}#{@live_views}/capabilities.ex",
      view_url: "#{@url}#{@live_views}/capabilities.ex",
      view_language: "elixir",
      raw_react_url: "#{@raw_url}#{@react}/capabilities.jsx",
      react_url: "#{@url}#{@react}/capabilities.jsx"
    }
  end
